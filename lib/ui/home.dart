...
///////////////////////////////////////////////////////////////////////////////////////////////
  ...
  fetch_watch() async {
    ...
    for (int i = 0; i < qn.docs.length; i++) {
      ...
      if (is_present) {
        print(
            "is_present is_present is_present is_present is_present ${qn.docs[i].reference.id} ddddddd ${allData['price']}");
  ...
  fetch_dress() async {
    ...
    for (int i = 0; i < qn.docs.length; i++) {
      ...
      if (is_present) {
        print(
            "is_present is_present is_present is_present is_present ${qn.docs[i].reference.id} ddddddd ${allData["reference"][0]}");
